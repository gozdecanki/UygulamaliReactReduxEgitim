    ...
    <div>
      ...
      <Container maxWidth="lg" >
        <Grid container spacing={2} sx={{ marginTop: 10 }}>
          <Grid item xs={12} md={6} lg={3} size={3}>
            <Course
              image={Angular}
              title="Angular"
          ...
          <Grid item xs={12} md={6} lg={3} size={3}>
            <Course
              ...
              Magnam iusto nihil ea deserunt culpa, maiores dolores eveniet architecto
               ratione quasi, odit ipsum minima tenetur nisi vitae eos quaerat in accusamus!"
            />
          </Grid>
          <Grid item xs={12} md={6} lg={3} size={3}>
            <Course
